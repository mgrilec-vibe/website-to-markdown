[![](https://blog.rust-lang.org/images/rust-logo-blk.svg) Rust Blog](https://blog.rust-lang.org/)
...
Apr. 3, 2025 · The Rust Release Team
...
## [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#what-s-in-1-86-0-stable)What's in 1.86.0 stable

### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#trait-upcasting)Trait upcasting

This release includes a long awaited feature — the ability to upcast trait objects. If a trait has a [supertrait](https://doc.rust-lang.org/reference/items/traits.html#supertraits) you can coerce a reference to said trait object to a reference to a trait object of the supertrait:
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#hashmaps-and-slices-now-support-indexing-multiple-elements-mutably)`HashMap`s and slices now support indexing multiple elements mutably
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#allow-safe-functions-to-be-marked-with-the-target-feature-attribute)Allow safe functions to be marked with the `#[target_feature]` attribute.

Previously only `unsafe` functions could be marked with the `#[target_feature]` attribute as it is unsound to call such functions without the target feature being enabled. This release stabilizes the `target_feature_11` feature, allowing _safe_ functions to be marked with the `#[target_feature]` attribute.
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#debug-assertions-that-pointers-are-non-null-when-required-for-soundness)Debug assertions that pointers are non-null when required for soundness
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#make-missing-abi-lint-warn-by-default)Make `missing_abi` lint warn by default
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#target-deprecation-warning-for-1-87-0)Target deprecation warning for 1.87.0
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#stabilized-apis)Stabilized APIs
...
### [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#other-changes)Other changes
...
## [](https://blog.rust-lang.org/2025/04/03/Rust-1.86.0/#contributors-to-1-86-0)Contributors to 1.86.0
...
[![Mastodon](https://blog.rust-lang.org/images/mastodon.svg)](https://social.rust-lang.org/@rust) [![Bluesky](https://blog.rust-lang.org/images/bluesky.svg)](https://bsky.app/profile/rust-lang.org) [![YouTube](https://blog.rust-lang.org/images/youtube.svg)](https://www.youtube.com/channel/UCaYhcUwRBNscFNUKTjgPFiA) [![Discord](https://blog.rust-lang.org/images/discord.svg)](https://discord.gg/rust-lang) [![GitHub](https://blog.rust-lang.org/images/github.svg)](https://github.com/rust-lang)
...
Maintained by the Rust Team. See a typo? [Send a fix here](https://github.com/rust-lang/blog.rust-lang.org/edit/main/content/Rust-1.86.0.md)!
