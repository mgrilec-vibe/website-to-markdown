...
6. Choose **Run diagnostic fixture** for a 26-cell one-fixture matrix or **Run full benchmark** for all 260 cells. Runs are serial and may take substantial time when local AI is active.
