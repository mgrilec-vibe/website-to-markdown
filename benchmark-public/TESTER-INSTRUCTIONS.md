...
6. Choose **Run focused quick benchmark** for a three-cell focused representative matrix (None@100, Custom@40, Browser@40) or **Run focused full benchmark** for all 130 focused cells across 10 fixtures. Runs are serial and may take substantial time when local AI is active. The live status names the current focused conversion or local-AI stage.
