# Testable Markdown Conversion

## Purpose

Provide a browser-independent, deterministic captured-HTML conversion pipeline with focused extraction, fixture validation, local benchmark evidence, and compression over precomputed conversions.
