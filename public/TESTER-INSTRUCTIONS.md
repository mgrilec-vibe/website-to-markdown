...
7. Open **Settings** from the result screen or the extension action menu to choose **None**, **Browser local AI**, or **Custom extractive** summarization, Detail, and automatic copying.
